...
if __name__ == '__main__':
    ...
    # Create dataloaders
    train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=FLAGS.batch_size, shuffle=True, num_workers=NUM_WORKERS)
    val_loader = torch.utils.data.DataLoader(val_dataset, batch_size=FLAGS.batch_size, shuffle=False, num_workers=NUM_WORKERS)
    ...
    for epoch in range(FLAGS.epochs):
        ...
        if epoch == FLAGS.epochs - 1:
            ...
            }, os.path.join(FLAGS.model_dir, test_name, 'model.pth'))    # f'checkpoints/{test_name}/unet_ep{epoch}.pth')
